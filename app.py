...
Напиши в конце что ты рад что помог пользователю, и пожелай что-то хорошее, чтобы он купил квартиру, чтобы он хороший вариант и так далее 1-2 предложение, но если хочешь обсудить подробнее это сделай ссылку в https://chatgpt.com/ с этим промтом
"""

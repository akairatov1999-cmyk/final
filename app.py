...
Дай совет что при покупки нужно первую очередь рассматривать в свой бюджет и везсть в дорогие кредиты кредиты, 2-3 предложение
Напиши в конце если подробнее обсудить это сделай ссылку в чатждпити с этим промтом
"""
